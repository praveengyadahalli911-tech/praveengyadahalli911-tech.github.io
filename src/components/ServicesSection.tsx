...
const SERVICES = [
  {
    ...
    description:
      'Custom software, websites, web applications, mobile apps, API development, and database solutions — building scalable digital products from concept to deployment.',
  },
  {
    number: '02',
    title: 'AI & Automation Solutions',
    description:
      'AI agents, chatbots, web scraping automation, AI calling agents, voice assistants, and workflow automation — turning manual processes into intelligent systems.',
  },
  {
    number: '03',
    title: 'Design & Branding',
    description:
      'Logo design, brand identity, social media creatives, posters, and marketing graphics — crafting visual identities that resonate with audiences.',
  },
  {
    number: '04',
    title: 'Media & Video Solutions',
    description:
      'Video editing, reels editing, promotional videos, motion graphics, and AI product videos — creating compelling visual content for digital platforms.',
  },
  {
    number: '05',
    title: 'Academic Solutions',
    description:
      'Student projects, major projects, research projects, documentation, and portfolio development — helping students turn ideas into production-ready applications.',
  },
];
