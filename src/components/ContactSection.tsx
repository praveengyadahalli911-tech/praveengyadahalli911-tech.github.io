import { Mail, Phone, MessageCircle, Linkedin, Github, Globe, ArrowUpRight } from 'lucide-react';
...
const CONTACT_METHODS: ContactMethod[] = [
  {
    ...
    label: 'Email',
    value: 'Send an Email',
    href: 'mailto:praveengyadahalli911@gmail.com',
  },
  {
    icon: Phone,
    label: 'Call',
    value: 'Give a Call',
    href: 'tel:+917353605383',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: 'Chat on WhatsApp',
    href: 'https://wa.me/917353605383',
  },
  {
    icon: Globe,
    label: 'Website',
    value: 'Visit Website',
    href: 'https://www.techpg.me/',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'Connect on LinkedIn',
    href: 'https://www.linkedin.com/in/praveen-goudappa-yadahalli-a88528317',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'View on GitHub',
    href: 'https://github.com/praveengyadahalli911-tech',
  },
];
...
const ContactSection = () => {
  return (
    ...
    >
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-5 md:gap-6">
